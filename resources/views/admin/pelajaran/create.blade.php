...
@section('breadcrumb')
    ...
    <span class="text-gray-300">/</span>
    <span class="text-gray-600 font-medium">Tambah Mapel</span>
@endsection

@section('content')
<div class="page-header">
    <h1 class="page-title">Tambah Mata Pelajaran</h1>
    <p class="page-subtitle">Tambahkan data mata pelajaran baru</p>
</div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <select name="jenis" id="jenis" 
                    ...
                    <option value="guru_kelas" {{ old('jenis') == 'guru_kelas' ? 'selected' : '' }}>Guru Kelas</option>
                    <option value="guru_mapel" {{ old('jenis') == 'guru_mapel' ? 'selected' : '' }}>Guru Mapel</option>
                </select>
                @error('jenis')
                    <p class="form-error">{{ $message }}</p>
                @enderror
